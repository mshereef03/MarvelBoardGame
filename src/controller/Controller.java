...
public class Controller implements ActionListener, MouseListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() instanceof JButton) {
			...
			if (button.getName().equals("abilityCurrentChampInfo_g")) {
				...
				if(a==null) {
					System.out.println("Model current champ: "+model.getCurrentChampion().getName());
					System.out.println("Model Turn Order Peek Min: "+((Champion)(model.getTurnOrder().peekMin())).getName());
					System.out.println("Button clicked on text: "+button.getText());
					for (Ability g : c.getAbilities()) {
						System.out.println("Ability "+g.getName());
					}
				}
				//silenced check if a is null
	...
	private void minimax(Game g,int depth) {
		boolean maximizing = g.getCurrentPlayerName().equals("AI");
		
	}
	
	private ArrayList<String> generateAllMoves(Game g) {
